...
<body>
                        ...
                        <div class="inner">
                            ...
                            <div id="tabs" class="row">
                                <div class="col-lg-4 col-md-5 col-sm-5 col-xs-12 main1">
                                    <ul id="accordion">
                                        <li>
                                            <a class="active" href="#tab-functions">
                                                <div class="tag">
                                                    <div class="icon"><div class="block">1</div></div>
                                                    <span class="title">Functions</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#tab-personalised">
                                                <div class="tag">
                                                    <div class="icon"><div class="block">2</div></div>
                                                    <span class="title">Personalised</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#tab-exercise">
                                                <div class="tag">
                                                    <div class="icon"><div class="block">3</div></div>
                                        ...
                                        <li>
                                            <a href="#tab-diet">
                                                <div class="tag">
                                                    <div class="icon"><div class="block">4</div></div>
                                        ...
                                        <li>
                                            <a href="#tab-dashboard">
                                                <div class="tag">
                                                    <div class="icon"><div class="block">5</div></div>
                                        ...
                                        <li>
                                            <a href="#tab-health">
                                                <div class="tag">
                                                    <div class="icon"><div class="block">6</div></div>
                                                    <span class="title">Health</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#tab-challenges">
                                                <div class="tag">
                                                    <div class="icon"><div class="block">7</div></div>
    ...
    $(function() {
        ...
        var firstLink = $("#accordion li a:first-child").click();
