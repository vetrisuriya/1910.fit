...
<body>
                            ...
                            <div class="card">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane active" id="tab-1">
                                        <div class="tab-inner">
                                            <div class="question"><span> Q:1 </span> Do you find yourself breathless going up a short flight of stairs?</div>
                                            <div class="answer">
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="tab-2">
                                        <div class="tab-inner">
                                            <div class="question"><span> Q:2 </span> Do you avoid social or recreational situations that may involve physical activity?</div>
                                            <div class="answer">
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="tab-3">
                                        <div class="tab-inner">
                                            <div class="question"><span> Q:3 </span> Are you unable to keep up with peers in recreational activities or sport competitions?</div>
                                            <div class="answer">
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="tab-4">
                                        <div class="tab-inner">
                                            <div class="question"><span> Q:4 </span> Are you able to lift a full bag of groceries from your vehicle?</div>
                                            <div class="answer">
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="tab-5">
                                        <div class="tab-inner">
                                            <div class="question"><span> Q:5 </span> Are you able to hold a child?</div>
                                            <div class="answer">
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="tab-6">
                                        <div class="tab-inner">
                                            <div class="question"><span> Q:6 </span> Are you limited in your recreational pursuits by a lack of strength?</div>
                                            <div class="answer">
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="tab-7">
                                        <div class="tab-inner">
                                            <div class="question"><span> Q:7 </span> Are you able to reach over to back of your shoulder?</div>
                                            <div class="answer">
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="tab-8">
                                        <div class="tab-inner">
                                            <div class="question"><span> Q:8 </span> Do you find it difficult to look behind you to check for traffic when driving?</div>
                                            <div class="answer">
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="tab-9">
                                        <div class="tab-inner">
                                            <div class="question"><span> Q:9 </span> Can you touch your toes standing with your leg straight?</div>
                                            <div class="answer">
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="tab-10">
                                        <div class="tab-inner">
                                            <div class="question"><span> Q:10 </span> Do you have to modify your movements (e.g., swinging your hand) to compensate for limited joint mobility?</div>
                                            <div class="answer">
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="tab-11">
                                        <div class="tab-inner">
                                            <div class="question"><span> Q:11 </span> How big is your Stomach?</div>
                                            <div class="answer">
                                        ...
                                        <div class="tab-btn">
                                            ...
                                            <button type="button" id="surveyButton" class="btn disabled" data-quesid="ques11">Submit</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    $(document).ready(function() {
        ...
        $("button[id='surveyButton']").on("click", function() {
            ...
            var ans11 = $("input[id='ques11']:checked").val();
