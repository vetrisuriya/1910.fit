$(document).ready(function () {
    ...
    var play_pause     = $('.videoContainer3 .playButton'),
        container      = $('.videoContainer3'),
        playIcon       = $('.videoContainer3 .playButton .playPause'),
        video          = $('.videoContainer3 video'),
        play           = $('.videoContainer3 .play'),
        volume         = $('.videoContainer3 .volume .icon'),
        volumeIntesity = $('.videoContainer3 .volume .intensityBar'),
        intensity      = $('.videoContainer3 .intensity'),
        progressBar    = $('.videoContainer3 .progressBar'),
        progress       = $('.videoContainer3 .progressBar .progress'),
        timer          = $('.videoContainer3 .intialTime'),
        vidDuration    = $('.videoContainer3 .fullTime'),
        expandButton   = $('.videoContainer3 .scale .icon'),
        overlayScreen  = $('.videoContainer3 .overlay'),
        timeState      = $('.videoContainer3 .time'),
        overlayButton  = $('.videoContainer3 .overlay .button'),
        update;
