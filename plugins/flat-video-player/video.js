$(document).ready(function () {
    ...
    var play_pause     = $('.videoContainer .playButton'),
        ...
        playIcon       = $('.videoContainer .playButton .playPause'),
        video          = $('.videoContainer video'),
        play           = $('.videoContainer .play'),
        volume         = $('.videoContainer .volume .icon'),
        volumeIntesity = $('.videoContainer .volume .intensityBar'),
        intensity      = $('.videoContainer .intensity'),
        progressBar    = $('.videoContainer .progressBar'),
        progress       = $('.videoContainer .progressBar .progress'),
        timer          = $('.videoContainer .intialTime'),
        vidDuration    = $('.videoContainer .fullTime'),
        expandButton   = $('.videoContainer .scale .icon'),
        overlayScreen  = $('.videoContainer .overlay'),
        timeState      = $('.videoContainer .time'),
