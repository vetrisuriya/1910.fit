$(document).ready(function () {
    ...
    var play_pause     = $('.videoContainer4 .playButton'),
        container      = $('.videoContainer4'),
        playIcon       = $('.videoContainer4 .playButton .playPause'),
        video          = $('.videoContainer4 video'),
        play           = $('.videoContainer4 .play'),
        volume         = $('.videoContainer4 .volume .icon'),
        volumeIntesity = $('.videoContainer4 .volume .intensityBar'),
        intensity      = $('.videoContainer4 .intensity'),
        progressBar    = $('.videoContainer4 .progressBar'),
        progress       = $('.videoContainer4 .progressBar .progress'),
        timer          = $('.videoContainer4 .intialTime'),
        vidDuration    = $('.videoContainer4 .fullTime'),
        expandButton   = $('.videoContainer4 .scale .icon'),
        overlayScreen  = $('.videoContainer4 .overlay'),
        timeState      = $('.videoContainer4 .time'),
        overlayButton  = $('.videoContainer4 .overlay .button'),
        update;
