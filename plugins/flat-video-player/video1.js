$(document).ready(function () {
    ...
    var play_pause     = $('.videoContainer1 .playButton'),
        container      = $('.videoContainer1'),
        playIcon       = $('.videoContainer1 .playButton .playPause'),
        video          = $('.videoContainer1 video'),
        play           = $('.videoContainer1 .play'),
        volume         = $('.videoContainer1 .volume .icon'),
        volumeIntesity = $('.videoContainer1 .volume .intensityBar'),
        intensity      = $('.videoContainer1 .intensity'),
        progressBar    = $('.videoContainer1 .progressBar'),
        progress       = $('.videoContainer1 .progressBar .progress'),
        timer          = $('.videoContainer1 .intialTime'),
        vidDuration    = $('.videoContainer1 .fullTime'),
        expandButton   = $('.videoContainer1 .scale .icon'),
        overlayScreen  = $('.videoContainer1 .overlay'),
        timeState      = $('.videoContainer1 .time'),
        overlayButton  = $('.videoContainer1 .overlay .button'),
        update;
