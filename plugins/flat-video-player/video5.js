$(document).ready(function () {
    ...
    var play_pause     = $('.videoContainer5 .playButton'),
        container      = $('.videoContainer5'),
        playIcon       = $('.videoContainer5 .playButton .playPause'),
        video          = $('.videoContainer5 video'),
        play           = $('.videoContainer5 .play'),
        volume         = $('.videoContainer5 .volume .icon'),
        volumeIntesity = $('.videoContainer5 .volume .intensityBar'),
        intensity      = $('.videoContainer5 .intensity'),
        progressBar    = $('.videoContainer5 .progressBar'),
        progress       = $('.videoContainer5 .progressBar .progress'),
        timer          = $('.videoContainer5 .intialTime'),
        vidDuration    = $('.videoContainer5 .fullTime'),
        expandButton   = $('.videoContainer5 .scale .icon'),
        overlayScreen  = $('.videoContainer5 .overlay'),
        timeState      = $('.videoContainer5 .time'),
        overlayButton  = $('.videoContainer5 .overlay .button'),
        update;
