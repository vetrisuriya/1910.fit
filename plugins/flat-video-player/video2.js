$(document).ready(function () {
    ...
    var play_pause     = $('.videoContainer2 .playButton'),
        container      = $('.videoContainer2'),
        playIcon       = $('.videoContainer2 .playButton .playPause'),
        video          = $('.videoContainer2 video'),
        play           = $('.videoContainer2 .play'),
        volume         = $('.videoContainer2 .volume .icon'),
        volumeIntesity = $('.videoContainer2 .volume .intensityBar'),
        intensity      = $('.videoContainer2 .intensity'),
        progressBar    = $('.videoContainer2 .progressBar'),
        progress       = $('.videoContainer2 .progressBar .progress'),
        timer          = $('.videoContainer2 .intialTime'),
        vidDuration    = $('.videoContainer2 .fullTime'),
        expandButton   = $('.videoContainer2 .scale .icon'),
        overlayScreen  = $('.videoContainer2 .overlay'),
        timeState      = $('.videoContainer2 .time'),
        overlayButton  = $('.videoContainer2 .overlay .button'),
        update;
